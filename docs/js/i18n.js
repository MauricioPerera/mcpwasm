...
(function () {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      "compare.mcpLi4": "Discovery: a separate tools/list RPC, before any call",
    ...
    es: {
      ...
      "compare.mcpLi4": "Descubrimiento: un RPC tools/list separado, antes de cualquier llamada",
    ...
    pt: {
      ...
      "compare.mcpLi4": "Descoberta: um RPC tools/list separado, antes de qualquer chamada",
