"""Tests para validate_test_coverage_findings.py: exit 2 ante findings.json corrupto.
...
import validate_test_coverage_findings as v  # noqa: E402


class TestCorruptFindings(unittest.TestCase):
    def setUp(self):
        self.base = tempfile.mkdtemp(prefix="tcfind_")
