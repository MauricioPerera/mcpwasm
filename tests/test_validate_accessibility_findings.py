"""Tests para validate_accessibility_findings.py: exit 2 ante findings.json corrupto.
...
import validate_accessibility_findings as v  # noqa: E402


class TestCorruptFindings(unittest.TestCase):
    def setUp(self):
        self.base = tempfile.mkdtemp(prefix="accfind_")
