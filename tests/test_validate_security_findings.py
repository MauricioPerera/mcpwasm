"""Tests para validate_security_findings.py: exit 2 ante findings.json corrupto.
...
import validate_security_findings as v  # noqa: E402


class TestCorruptFindings(unittest.TestCase):
    def setUp(self):
        self.base = tempfile.mkdtemp(prefix="secfind_")
